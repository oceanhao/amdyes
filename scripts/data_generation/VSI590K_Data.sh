...
NPROC_PER_NODE=8  # 每节点进程数（GPU 数）

# ======================
# Path Configuration
# ======================
MODEL_PATH="/remote-home/haohh/_cvpr2025/VG-LLM/ckpt_saves/mhan/flex-percept-coldv2-3e"  # [ModelArguments]
GEOMETRY_ENCODER_TYPE="vggt"
GEOMETRY_ENCODER_PATH="facebook/VGGT-1B"
STAGE="vsiData_generation"
CACHE_DIR="./cache"                        # [TrainingArguments]
OTHER_TAG="ourckpt_forcevggt_4090_118" #"ourckpt_forcevggt" "ourckpt_novggt"
